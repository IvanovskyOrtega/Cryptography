...
//Modificado por: Ortega Victoriano Ivan
//Curso: Análisis de algoritmos
//(C) Enero 2013
//ESCOM-IPN
//Ejemplo de medición de tiempo en C y recepción de parametros en C/C++ bajo UNIX
//Compilación de la libreria: "g++ -c tiempo.cpp " (Generación del código objeto)
//*****************************************************************
...
//Devuelve: Sin devolución. (Parámetros modificados por referencia)
//*****************************************************************
#ifndef _TIEMPO_HPP_
#define _TIEMPO_HPP_
